	    ...
	    <section id="hero" class="hero section">
	      ...
	      <div class="container text-center">
	      	<div class="d-flex flex-column justify-content-center align-items-center">
	          	<h1 data-aos="fade-up"><span><i class="bi bi-exclamation-triangle-fill"></i> 403</span> Forbidden</h1>
	          	<p data-aos="fade-up mt-2" data-aos-delay="100">죄송합니다. 이 페이지를 볼 수 있는 권한이 없습니다.</p>
