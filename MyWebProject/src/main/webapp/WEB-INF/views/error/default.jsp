	    ...
	    <section id="hero" class="hero section">
	      ...
	      <div class="container text-center">
	      	<div class="d-flex flex-column justify-content-center align-items-center">
	          	<h1 data-aos="fade-up"><span><i class="bi bi-exclamation-triangle-fill"></i> ERROR</span> 오류</h1>
	          	<p data-aos="fade-up mt-2" data-aos-delay="100">죄송합니다. 예기치못한 오류가 발생했습니다.</p>
