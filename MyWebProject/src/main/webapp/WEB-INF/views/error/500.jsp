	    ...
	    <section id="hero" class="hero section">
	      ...
	      <div class="container text-center">
	      	<div class="d-flex flex-column justify-content-center align-items-center">
	          	<h1 data-aos="fade-up"><span><i class="bi bi-exclamation-triangle-fill"></i> 500</span> Internal Server Error</h1>
	          	<p data-aos="fade-up mt-2" data-aos-delay="100">죄송합니다. 서버 내부 오류가 발생 하였습니다.</p>
